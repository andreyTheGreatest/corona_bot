...
const API_TOKEN = process.env.TELEGRAM_TOKEN || '1114937560:AAEWwk_x9TLJ_qTiGg9P2dakFNA4Gmgq6_0';
const PORT = process.env.PORT || 3000;
const BOT_URL = process.env.URL || 'https://telegram-bot-hoster.herokuapp.com';

const bot = new Telegraf(API_TOKEN);
bot.telegram.setWebhook(`${BOT_URL}/bot${API_TOKEN}`);
